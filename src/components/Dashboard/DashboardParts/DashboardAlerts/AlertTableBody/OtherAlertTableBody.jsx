...
import { useGetOtherAlertQuery } from "../../../../../Redux/service/Alerts/Alerts";
import Loader from "../../../../Helpers/Loader/Loader";
import { formatDateString } from "../../../../../JsHelpers/DateFormat";
import axios from "axios";
import TableRowButton from "../../../../Helpers/Table/TableRowButton";

const OtherAlertTableBody = ({ limit, currentPage, setTotalPages, query }) => {
  const { data, isLoading, isError } = useGetOtherAlertQuery(
    {
      page: currentPage,
      limit: limit,
      search: query,
    ...
    <>
      {tableData.map((alert) => (
        <div key={alert.id} className="table-row">
          ...
          <TableRow value={alert.type ? alert.type : "- - - - -"} />
          <TableRow
            value={
...
export default OtherAlertTableBody;
